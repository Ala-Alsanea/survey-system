...
class GainMoneyChart extends ChartWidget
{
    protected static ?string $heading = 'Teacher receive financial support from other party Chart';

    protected function getData(): array
    {
        $district = array_values(TeacherInfo::pluck('district')->unique()->all());
        // $answers = array_values(Survey::pluck('gain_money')->unique()->all());
