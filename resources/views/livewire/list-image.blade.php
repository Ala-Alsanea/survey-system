    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
        ...
        @foreach ($this->images as $img)
            @if ($img->image_national_card_front)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->image_national_card_front) }}">
            ...
            @if ($img->image_national_card_back)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->image_national_card_back) }}">
            ...
            @if ($img->image_attend)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->image_attend) }}">
            ...
            @if ($img->image_contract_direct_work)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->image_contract_direct_work) }}">
                    <div class="overflow-hidden rounded shadow-lg">
            ...
            @if ($img->oct_image_attend)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->oct_image_attend) }}">
                    <div class="overflow-hidden rounded shadow-lg">
            ...
            @if ($img->nov_image_attend)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->nov_image_attend) }}">
                    <div class="overflow-hidden rounded shadow-lg">
            ...
            @if ($img->dec_image_attend)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->dec_image_attend) }}">
                    <div class="overflow-hidden rounded shadow-lg">
            ...
            @if ($img->school_image)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->school_image) }}">
                    <div class="overflow-hidden rounded shadow-lg">
            ...
            @if ($img->eduqual_image)
                <a wire:key='{{ $img->id }}' target="_blank"
                    href="{{ $this->getStorageName($img->eduqual_image) }}">
                    <div class="overflow-hidden rounded shadow-lg">
