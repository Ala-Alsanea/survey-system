@php
    ...
    $descriptionIconClasses = \Illuminate\Support\Arr::toCssClasses([
        'fi-wi-stats-overview-stat-description-icon h-10 w-10',
...
<{!! $tag !!}
    ...
    {{ $getExtraAttributeBag()->class([
        'fi-wi-stats-overview-stat flex gap-x-3 items-center content-center justify-start relative rounded-xl bg-white py-2 px-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 h-auto',
    ]) }}
    {{-- style="height: 4rem;" --}}>
